...
repository.acceptRunEvent({ schema_version: "0.1.0", event_id: `${runId}:knowledge-query:q1`, cospec_run_id: runId, event_type: "knowledge_query_finished", occurred_at: at(-60_000), query_id: "q1", query_status: "degraded", kb_name: "桌面云产品知识库", kb_version: "2026.09", kb_revision: "sha256:abc", query_source: "workflow", consumer_skill: "spec-clarify-requirement", answerability: "partially_answerable", hit_count: 4, citation_count: 2, warning_count: 1, query_detail: { question: "国产域控支持哪些能力？", answer: "支持批量加域和单点登录。[KB-1]", kb_root: "/fixture/product-kb", retrieval: "adapter_topk", top_k: 8, hits: [{ path: "02-产品能力/国产域控.md", heading: "支持能力", excerpt: "支持虚拟机批量加入国产域。", rank: 1 }], citations: [{ id: "KB-1", path: "02-产品能力/国产域控.md", heading: "支持能力" }], warnings: [{ code: "SOURCE_GAP", message: "统信域控版本信息待补充" }], obligations: [{ id: "O1", text: "确认支持能力", status: "covered" }], coverage: { covered: ["O1"], missing: [], conflict: [] } } });
