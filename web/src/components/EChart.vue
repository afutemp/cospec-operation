...
onMounted(() => { chart = echarts.init(root.value!); chart.setOption(props.option); chart.on("click", (event) => emit("chart-click", event)); window.addEventListener("resize", resize); });
