...
const filters = reactive({ dates: [] as string[], agentType: "", agentVersion: "", model: "", cospecPluginVersion: "" });
...
function reset() { rangePreset.value = "week"; filters.dates = []; filters.agentType = ""; filters.agentVersion = ""; filters.model = ""; filters.cospecPluginVersion = ""; }
</script>
